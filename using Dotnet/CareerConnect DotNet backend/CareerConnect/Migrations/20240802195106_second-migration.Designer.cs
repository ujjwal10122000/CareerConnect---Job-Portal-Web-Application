...
namespace CareerConnect.Migrations
{
    ...
    [Migration("20240802195106_second-migration")]
            ...
            modelBuilder.Entity("CareerConnect.Models.Employer", b =>
                {
                    b.HasOne("CareerConnect.Models.User", "User")
                        .WithOne("Employer")
                        .HasForeignKey("CareerConnect.Models.Employer", "EmployerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CareerConnect.Models.JobSeeker", b =>
                {
                    b.HasOne("CareerConnect.Models.User", "User")
                        .WithOne("JobSeeker")
                        .HasForeignKey("CareerConnect.Models.JobSeeker", "JobSeekerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
